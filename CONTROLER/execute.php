...
//$worker1 = Factory::getWorker('théo', 'blin', $date1, '0612121212', $date2, 'expert', 'théo', 'admin');
//$worker2 = Factory::getWorker('Manû', 'tchaô', $date1, '0612121212', $date2, 'sénior', 'manû', 'admin');
//$worker3 = Factory::getWorker('Phanu', 'gaden', $date1, '0612121212', $date2, 'apprenti', 'phanu', 'admin');
//
